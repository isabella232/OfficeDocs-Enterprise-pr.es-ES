...
Para las cuentas de usuario que han deshabilitado los servicios, puede habilitar todos los servicios para un plan de licencias específico con estos comandos:
