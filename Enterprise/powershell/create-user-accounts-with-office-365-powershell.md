...
**Resumen:** Aprenda a utilizar Office 365 PowerShell para crear cuentas de usuario en Office 365.
...
ShawnM@contoso.onmicrosoft.com,Shawn,Melendez,Shawn Melendez,US,contoso:ENTERPRISEPACK
 ...
 > [!NOTE]
>Los nombres de columna y su orden en la primera fila del archivo CSV son arbitrarios, pero asegúrese de que los datos en el resto del archivo coincide con el orden de los nombres de columna y utilizan los nombres de columna para los valores de parámetro en el comando de PowerShell de Office 365.
...
Para utilizar el cmdlet **New-AzureADUser** desde el módulo de Active Directory V2 PowerShell de Azure, debe conectarse primero a su suscripción. Para las instrucciones, vea [Conectar con el módulo de Active Directory V2 PowerShell de Azure](https://go.microsoft.com/fwlink/?linkid=842218).
