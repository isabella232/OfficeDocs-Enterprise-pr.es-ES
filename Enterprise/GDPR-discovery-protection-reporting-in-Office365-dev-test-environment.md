...
Realice primero los pasos de la [fase 2 del artículo sobre el entorno de desarrollo y pruebas de Office 365](office-365-dev-test-environment.md#phase-2-create-an-office-365-trial-subscription).
...
Nota: Este conjunto de datos de ejemplo deriva de información disponible públicamente y debe usarse solamente para realizar pruebas.

3. En una nueva pestaña del explorador, escriba: **https://**\<suNombreDeInquilino\>**.sharepoint.com**.
