...
![Figura 1: La ruta de acceso de red sin ExpressRoute](images/27796846-3b0a-4bbc-8b39-22552d037fba.png)
...
![Figura 2: La ruta de acceso de red con ExpressRoute](images/a22eccb1-e3d2-4c69-a751-6539ffc0d8c2.png)
...
|:-----|:-----|:-----|
|![Modelo de conectividad de ExpressRoute: Colocalizado en un intercambio de nube](images/415cd5b2-2b5a-4aeb-8018-8af61d9f9ab6.png)|![Modelo de conectividad de ExpressRoute: Ethernet de punto a punto](images/0582afa7-b46d-4da9-80ff-f0553ac93676.png)|![Modelo de conectividad de ExpressRoute: Conexión (IP VPN) universal](images/2884618e-ff38-471a-a1e0-fd55483938e5.png)|
...
![Figura 3: Las tres relaciones BGP en una sola conexión de ExpressRoute](images/f16e3eaf-9fd5-4513-9a15-dcf66f07756f.png)
...
![Figura 4: Una aplicación de una máquina virtual de Azure que obtiene acceso a una granja de SharePoint local](images/293dbdb7-e8f6-4399-8fdd-b7e4d0b33e66.png)
...
![Figura 5: Traslado de la granja de SharePoint local a SharePoint Online](images/d2140875-5fd3-44ce-b863-e93ad8680038.png)
...
![Figura 6: Flujo de tráfico cuando se migra la granja de SharePoint a SharePoint Online en Office 365](images/30623d29-a9e6-4d38-bb7a-683adcea3395.png)
...
![Figura 7: Ejemplo de una organización distribuida geográficamente que usa una sola conexión de ExpressRoute](images/f0c19a74-d67c-42de-8b1a-a122729b4abb.png)
...
![Figura 8: El uso de varias conexiones de ExpressRoute para la entrega óptima en centros de datos regionales](images/e6980050-48ee-41f7-9f81-7953e783ee1b.png)
...
![Figura 9: La red mundial en la nube de Microsoft](images/c65c740a-f20c-4c77-b3b2-624b39ef0aa3.png)
