...
| Recopilar el número y el tamaño de los buzones (incluidos los buzones compartidos y las salas de conferencias) |||||
| Recopilar configuraciones y versiones de cliente (exploradores, sistemas operativos, aplicaciones de Office, versiones móviles, etc.) |||||
| Recopilar detalles de la configuración de red (hosts DNS, configuración de firewall o proxy, conectividad a Internet) |||||
| Recopilar información sobre ubicaciones de almacenamiento de archivos (recursos compartidos de archivos, almacenamiento de archivos de intranet) |||||
| Recopilar detalles sobre los sitios de intranet que tiene previsto migrar |||||
| Recopilar la reunión en línea y los sistemas de mensajería instantánea que tiene previsto migrar |||||
| Recopilar los detalles de las aplicaciones integradas con los sistemas existentes (aplicaciones habilitadas para correo, flujo de trabajo, CRM, etc.) |||||
|Tomar decisiones clave de implementación |||||
| ¿Cómo va [a crear o a sincronizar las cuentas](https://go.microsoft.com/fwlink/?LinkId=534819)? |||||
| ¿Cómo se [autenticarán las cuentas de usuario](https://go.microsoft.com/fwlink/?LinkId=534820)? |||||
| ¿Migrará todos los datos y cómo ocurrirá esa migración ( [correo electrónico](https://go.microsoft.com/fwlink/?LinkId=534823) y [archivos](https://go.microsoft.com/fwlink/?LinkId=534824))? |||||
| ¿Habrá una integración a corto o largo plazo [con sistemas locales](https://go.microsoft.com/fwlink/?LinkId=534822)? |||||
| ¿Con qué [dispositivos podrán conectarse los usuarios](https://go.microsoft.com/fwlink/?LinkId=534821) (de forma remota, desde dispositivos móviles o solo desde la red)? |||||
|**Corrección de posibles bloqueadores de implementación** |||||
|Con herramientas y orientación de Microsoft: |||||
| Limpieza de cuentas de Active Directory ( [Guía](https://go.microsoft.com/fwlink/?LinkId=534825) y [herramienta](https://go.microsoft.com/fwlink/?LinkId=534826)) |||||
| Preparar los datos para una migración ( [correo electrónico](https://go.microsoft.com/fwlink/?LinkId=534823) y [archivos](https://go.microsoft.com/fwlink/?LinkId=534824)) |||||
...
| Informar a los usuarios de que pueden [empezar a usar Microsoft 365](https://support.microsoft.com/office/microsoft-365-basics-video-training-396b8d9e-e118-42d0-8a0d-87d1f2f055fb) |||||
