...
# Diagrama accesible: Integración de redes de productos de servidores de Microsoft Office

Este artículo es una versión de texto accesible del diagrama con el nombre Integración de red de los productos de servidor de Microsoft Office.
...
## Conceptos de alto nivel para Lync, Exchange, SharePoint Server y Office Web Apps
...
#### Equilibrador de carga y dispositivos de proxy inverso
...
### Consideraciones sobre el Sistema de nombres de dominio (DNS)
...
#### Tráfico de correo electrónico basado en la nube
...
#### Autenticación para acceso externo
...
#### Enrutador de puerta de enlace con ACL
...
#### Servidores de acceso remoto para Lync y SharePoint
...
#### Equilibrador de carga y dispositivo de proxy inverso
...
#### Nivel de acceso de cliente front-end
...
#### Nivel de base de datos y almacenamiento de información
...
#### Descripción de cómo se mueve el tráfico a través de los componentes a los distintos niveles de servidor

Esta sección describe cómo se mueven las solicitudes del usuario a través de la topología de red. 
  
#### Autenticación y enrutamiento para acceso externo
...
#### Empresas asociadas (negocio a negocio) (https://partnerweb.contoso.com)
...
#### Asociados particulares (SharePoint) y anónimos (Lync) (https://partnerweb.contoso.com y https://meet.contoso.com)
...
#### Empleados remotos y con movilidad
...
#### Autenticación para acceso interno
...
#### Tráfico SIP de Lync y tráfico de Lync Web
...
#### Tráfico de cliente de SharePoint
...
#### Tráfico de cliente de Exchange y tráfico del servidor de correo de Exchange
...
#### ¿Desea conocer más sobre el tráfico de red de Lync?
