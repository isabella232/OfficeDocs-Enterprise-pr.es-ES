...
# Diagrama accesible: Sitios de Internet en Microsoft Azure para SharePoint 2013

Este artículo es una versión de texto accesible del diagrama con el nombre Sitios de Internet en Microsoft Azure para SharePoint 2013.
...
### Ejemplo: Granja de servidores de sitios de Internet de tamaño medio (~85 vistas de página por segundo)
...
### Diseño de cuentas y autenticación

Determine cómo se administrarán las cuentas y qué tipo de autenticación se usará. 
  
#### Cuentas para desarrolladores y creadores de sitios
...
### Diseño para la conexión a Azure AD
...
- Una colección de sitios basados en la ruta de acceso que se encuentra en http://internal:8000 (sitio raíz). 
