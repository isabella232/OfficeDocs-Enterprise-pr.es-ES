...
## Usar Servicios de infraestructura de Azure para recuperación ante desastres
<a name="AZ"> </a>
...
![Muestra elementos clave y de topología de una granja de servidores de producción de SharePoint y una granja de servidores de recuperación con espera semiactiva.](images/AZarch_TopWarmStndby.gif)
...
## Fase 1: Diseñar el entorno de recuperación ante desastres
<a name="Phase1"> </a>
...
## Fase 2: Crear la red virtual de Azure y la conexión VPN
<a name="Phase2"> </a>
...
## Fase 3: Implementar Active Directory y servicios de nombres de dominio en la red virtual de Azure
<a name="Phase3"> </a>
...
## Fase 4: Implementar la granja de servidores de recuperación de SharePoint en Azure
<a name="Phase4"> </a>
...
## Fase 5: Configurar DFSR entre las granjas de servidores
<a name="Phase5"> </a>
...
## Fase 6: Configurar el trasvase de registros a la granja de servidores de recuperación
<a name="Phase6"> </a>
...
## Fase 7: Validar la conmutación por error y la recuperación
<a name="Phase7"> </a>
...
### Detener el trasvase de registros
...
### Rastrear el origen de contenido
...
### Recuperar servicios de la granja de servidores
<a name="Reco"> </a>
...
## Entorno de prueba de concepto de Microsoft
<a name="POC"> </a>
...
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Unidad del sistema  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\  <br/> |
|E  <br/> |80  <br/> |Unidad de registro (40 GB)  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |80  <br/> |Página (36 GB)  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\Microsoft SQL Server\\MSSQL\\DATA\\DATA  <br/> |
...
|**Letra de unidad**|**Tamaño**|**Nombre de directorio**|**Ruta de acceso**|
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Directorio raíz de datos  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\  <br/> |
|E  <br/> |500  <br/> |Directorio de base de datos de usuario  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |500  <br/> |Directorio de registro de base de datos de usuario  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|G  <br/> |500  <br/> |Directorio de base de datos temporal  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|H  <br/> |500  <br/> |Directorio de registro de base de datos temporal  <br/> |<letraDeUnidad>:\\Archivos de programa\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
...
### Al usar la Herramienta de administración del almacén de términos se produce un error que indica que la conexión o el almacén de metadatos administrado no están disponibles"
...
### Los conjuntos de términos personalizados no están disponibles en la colección de sitios

Compruebe si falta alguna asociación de aplicación de servicio entre la colección de sitios de contenido y el concentrador de tipo de contenido. Además, en la pantalla de propiedades de **Metadatos administrados - Conexión de <nombre de la colección de sitios>**, asegúrese de que esta opción está habilitada: **Esta aplicación de servicio es la ubicación de almacenamiento predeterminada para conjuntos de términos específicos de columnas.**
  
### El comando Get-ADForest de Windows PowerShell genera el error: "El término 'Get-ADForest' no se reconoce como nombre de un cmdlet, función, archivo de script o programa ejecutable"
...
### Se produce un error en la creación del grupo de disponibilidad al iniciar la sesión de XEvent 'AlwaysOn_health' en '<nombre de servidor>'

Asegúrese de que los dos nodos del clúster de conmutación por error tienen el estado "Arriba" y no "En pausa" o "Detenido".
  
### El trabajo de trasvase de registros de SQL Server genera un error de acceso denegado al intentar conectar con el recurso compartido de archivos

Asegúrese de que el Agente SQL Server se ejecuta con credenciales de red, en lugar de las credenciales predeterminadas.
  
### El trabajo de trasvase de registros de SQL Server indica que se ha realizado correctamente, pero no se ha copiado ningún archivo
...
### El servicio de metadatos administrados (u otro servicio de SharePoint) no se puede iniciar automáticamente después de la instalación
...
### Después de cambiar DNS al entorno de conmutación por error de Azure, los exploradores de los clientes siguen usando la antigua dirección IP para el sitio de SharePoint
