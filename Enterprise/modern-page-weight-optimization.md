...
- [Optimizar el rendimiento de la página en SharePoint](https://docs.microsoft.com/es-ES/sharepoint/dev/general-development/optimize-page-performance-in-sharepoint)
