...
# Diagrama accesible: Opciones de plataformas de Microsoft SharePoint 2013

Este artículo es una versión de texto accesible del diagrama Opciones de plataforma para Microsoft SharePoint 2013.
...
## Comparación de cuatro implementaciones diferentes para la plataforma de SharePoint 2013
...
### Tipo de implementación idóneo para...
...
## Tres cargas de trabajo típicas para pasar a Azure

### Office 365 y componentes de directorio de Azure
...
#### Solo servidor de sincronización de directorios
...
#### Sincronización de directorios + AD FS
...
### Sitio de Internet de orientación pública y Azure AD para autenticación de clientes
...
#### Ventajas de Azure para sitios de Internet
...
### Granja local y recuperación ante desastres en Azure
