...
# Diagrama accesible: Opciones de plataformas de Microsoft Lync 2013

Este artículo es una versión de texto accesible del diagrama con el nombre Opciones de plataformas de Microsoft Lync 2013, que está disponible en [Diagramas técnicos](http://go.microsoft.com/fwlink/?LinkID=519139).
...
## Comparación de cuatro implementaciones diferentes para la plataforma de Lync 2013
...
#### Implementación híbrida de Lync Online/Server (dominio dividido)
...
#### Lync Server hospedado por el proveedor
...
### Responsabilidades del profesional de TI
...
## Dos ejemplos de escenarios de implementación de Lync 2013

### Componentes de sincronización de directorios en Microsoft Azure
...
### Integración de Lync con Exchange y SharePoint en Office 365

#### Lync Server con Exchange Online y SharePoint Online
...
#### Exchange Server con Lync Online
