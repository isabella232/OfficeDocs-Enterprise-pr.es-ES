...
# Diagrama accesible: Opciones de plataformas de Microsoft Exchange 2013

Este artículo es una versión de texto accesible del diagrama con el nombre Opciones de plataforma de Microsoft Exchange 2013, que está disponible en [Diagramas técnicos](http://go.microsoft.com/fwlink/?LinkID=519139).
...
## Comparación de cuatro implementaciones diferentes para la plataforma de Exchange 2013
...
#### Exchange hospedado por el proveedor
...
### Integración con Lync y SharePoint
