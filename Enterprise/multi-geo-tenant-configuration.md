...
3.  Use el cmdlet [Set-MsolUser](https://docs.microsoft.com/es-ES/powershell/msonline/v1/set-msoluser) para establecer la ubicación de datos preferida de cada uno de los usuarios. Por ejemplo:
