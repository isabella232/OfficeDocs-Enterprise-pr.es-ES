...
#### [Administración de un entorno de multigeográfico](administering-a-multi-geo-environment.md)
...
#### [Configurar la búsqueda en OneDrive para la Empresa multigeográfico](configure-search-for-multi-geo.md)
...
#### [Entorno de desarrollo y prueba GDPR de Office 365](GDPR-discovery-protection-reporting-in-Office365-dev-test-environment.md)
