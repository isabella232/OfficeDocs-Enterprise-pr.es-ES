...
En Estados Unidos, antes de cada ubicación de cada miembro del personal del proveedor que deba realizar para Microsoft, en la medida en que lo permitiera la legislación local, el proveedor llevará a cabo una preinstalación y para ciertas ubicaciones, periódicamente, comprobando el fondo usando proveedor de servicios de detección de comprobaciones de segundo plano preferido que confirmará a Microsoft que la detección cumple con el estándar de Microsoft. 

Internacionalmente, el requisito anterior se implementará en todos los países en septiembre de 2020 y en los que no se implemente actualmente, el contrato con el tercero especifica los requisitos de Microsoft para el filtrado que deben realizarse y el proveedor es responsable de certificar a Microsoft por escrito que la comprobación de fondo se ha completado correctamente.
