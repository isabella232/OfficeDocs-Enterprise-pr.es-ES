...
Para obtener los pasos detallados, vea la **fase 1** de [Implementar un sitio de grupo SharePoint Online aislado](deploy-an-isolated-sharepoint-online-team-site.md).
...
Para obtener los pasos detallados, vea [Implementar un sitio de grupo SharePoint Online aislado](deploy-an-isolated-sharepoint-online-team-site.md).
