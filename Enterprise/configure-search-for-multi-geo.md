...
<p>Figura 1: Búsqueda en un arrendatario con tres ubicaciones de geo</p></th>
<th align="left"><p>Cliente de búsqueda llama el extremo del resto de búsqueda con la propiedad de consulta EnableMultiGeoSearch = true.</p>
<p>La consulta se envía a todas las ubicaciones de geo de los inquilinos.</p>
<p>Resultados de la búsqueda de cada ubicación geográfica se combinan y clasificados.</p>
<p>El cliente obtiene los resultados de la búsqueda unificada.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
### Obtener un centro de búsqueda para mostrar los resultados de todas las ubicaciones de geo
...
3.  Seleccione vertical para configurar, haga clic en el icono de engranaje de **configuración** en la esquina superior derecha y, a continuación, haga clic en **Editar página**.

> ![](media/configure-search-for-multi-geo_image2.png)
>
> La página de resultados de búsqueda se abre en modo de edición.

1.  En el elemento Web de resultados de búsqueda, mueva el puntero a la parte superior, la esquina derecha del elemento Web, haga clic en la flecha y, a continuación, haga clic en **Modificar elemento Web** en el menú. ![](media/configure-search-for-multi-geo_image3.png)

> Se abre el panel de herramientas elemento Web resultados de la búsqueda en la cinta de opciones en la parte superior derecha de la página.
...
**MultiGeoSearchStatus** : ésta es una propiedad que devuelve la API de búsqueda de SharePoint en respuesta a una solicitud. El valor de la propiedad es una cadena y proporciona la siguiente información acerca de los resultados que devuelve la API de búsqueda de SharePoint:
...
<td align="left">La consulta no era una consulta Multi-Geo y no fue abanico a otras ubicaciones geo.</td>
</tr>
</tbody>
</table>
