...
## <a name="create-azure-ad-tenant-and-namespace"></a>Crear el inquilino y el espacio de nombres de Azure AD
...
## <a name="add-a-ws-federation-identity-provider-to-the-namespace"></a>Agregar un proveedor de identidad de WS-Federation al espacio de nombres
...
## <a name="add-sharepoint-as-a-relying-party-application"></a>Agregar SharePoint como una aplicación de usuario de confianza
...
## <a name="create-a-rule-group-for-claims-based-authentication"></a>Crear un grupo de reglas para la autenticación basada en notificaciones
...
## <a name="configure-the-x509-certificate"></a>Configurar el certificado X.509
...
## <a name="create-a-claim-mapping-by-using-windows-powershell"></a>Crear una asignación de notificaciones mediante Windows PowerShell
...
## <a name="configure-sharepoint-for-the-new-identity-provider"></a>Configurar SharePoint para el nuevo proveedor de identidad
...
## <a name="set-the-permissions"></a>Establecer los permisos
...
## <a name="verify-the-new-provider"></a>Comprobar el nuevo proveedor
