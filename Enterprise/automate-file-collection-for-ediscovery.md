...
# Automatizar la recopilación de archivos para la exhibición de documentos electrónicos
...
### Implementar el uso compartido de archivos
...
### Configurar el GPO para el grupo Administradores y el script de inicio de sesión
...
### Opción A de importación de PST, script para Exchange Server 2013
...
6. Por ejemplo, si desea importar todos los archivos PST de la ruta de acceso \\\\Staging\\Cases$ en un buzón con el alias eDiscoveryMailbox, debería ejecutar el script de la siguiente manera `\\\\staging\\AFCscripts\\PSTImportScript.ps1 \\\\Staging\\cases$ eDiscoveryMailbox`.
    
### Opción B de importación de PST, para Exchange Online
...
### Búsqueda local de SharePoint para el almacenamiento en frío
...
### Supervisar los archivos recopilados y revisar los archivos de registro.
...
### Opción A de importación de PST para Exchange Server 2013
...
### Mover a un almacenamiento en frío
