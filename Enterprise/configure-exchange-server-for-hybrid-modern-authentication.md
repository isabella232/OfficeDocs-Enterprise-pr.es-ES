...
Obligar a los usuarios de Outlook a realizar la autenticación moderna  
[Requisitos de configuración de autenticación moderna para la transición de Office 365 dedicado/ITAR a vNext](modern-authentication-configuration.md)
