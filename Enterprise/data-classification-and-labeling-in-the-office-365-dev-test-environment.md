...
1. En Internet Explorer o en el explorador, vaya a [http://portal.office.com](http://portal.office.com) y el inicio de sesión con su cuenta de administrador global de Office 365.
...
1. 	En la pestaña Centro de administración de Office 365, haga clic en **Usuarios**.
...
1. Use el explorador y vaya al [portal de Azure](http://portal.azure.com).
    
2. 	Haga clic en **Grupos de recursos** [el nombre del grupo de recursos] **> CLIENTE1 > Conectar**.
    
3. En CLIENT1, ejecute Internet Explorer, vaya al portal de Office en [http://portal.office.com](http://portal.office.com)y, a continuación, inicie sesión con el nombre de la cuenta User5 y la contraseña.
    
4. En la pestaña **Inicio de Microsoft Office**, haga clic en **Instalar Office 2016**.
...
1. En el explorador o Internet Explorer, vaya a la [página de descarga de protección de la información de Microsoft Azure](https://www.microsoft.com/download/details.aspx?id=53018).
...
4. En **recurso compartido de 'Colección de sitios de soporte técnico'**, haga clic en **Avanzadas**.
...
7. En **recurso compartido de 'Colección de sitios de soporte técnico'**, escriba **todos los usuarios**, haga clic en **todos excepto los usuarios externos**y, a continuación, haga clic en **compartir.**
...
3. En la página **Office 365 iniciar sesión** , haga clic en el nombre de cuenta de User5 e iniciar sesión.
